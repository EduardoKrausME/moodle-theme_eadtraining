    ...
    var frontpage = {
        ...
        add_block_modal_init: function () {
            async function loadFiles() {
                const response = await fetch(`${M.cfg.wwwroot}/theme/eadtraining/_editor/model/?lang=${frontpage.lang}`);
                                ...
                                <div class="item-model-border">
                                    ...
                                    <div>
                                        <a class="btn btn-primary mb-2"
                                           ...
                                           >${M.util.get_string("add_block_edit", "theme_eadtraining")}</a>
        ...
        buildEditorCreateUrl: function (template) {
            ...
            return `${M.cfg.wwwroot}/theme/eadtraining/_editor/editor.php?${params.toString()}`;
        },
        ...
        block_order_save_order: function () {
            ...
            $.ajax({
                url: `${M.cfg.wwwroot}/theme/eadtraining/_editor/actions.php?action=page-order&local=${encodeURIComponent(frontpage.local)}`,
                type: "POST",
                data: {
                    order: order,
