<?php
// This file is part of the theme_eadtraining plugin for Moodle - http://moodle.org/
//
...
namespace theme_eadtraining\events;
...
class event_observers {
    ...
    public static function course_module_created(course_module_created $event): void {
        ...
        global $USER;
        $USER->theme_eadtraining_redirect_to_editor = $redirecturl;
    }
    ...
    public static function course_module_deleted(course_module_deleted $event): void {
        ...
        self::delete_coursemodule_filearea($cmid, "theme_eadtraining_customimage");
        self::delete_coursemodule_filearea($cmid, "theme_eadtraining_customicon");
        page_editor_manager::delete_for_cmid($cmid);

        set_config("theme_eadtraining_customimage_{$cmid}", null, "theme_eadtraining");
        set_config("theme_eadtraining_customicon_{$cmid}", null, "theme_eadtraining");
        set_config("theme_eadtraining_customcolor_{$cmid}", null, "theme_eadtraining");
