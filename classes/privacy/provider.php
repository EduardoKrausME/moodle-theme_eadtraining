 ...
 * Privacy Subsystem implementation for theme_eadtraining.
 *
...
namespace theme_eadtraining\privacy;
...
class provider implements
    ...
    const ACCESSIBILITY_LOG_TABLE = 'theme_eadtraining_accesslog';
    ...
    public static function get_metadata(collection $items): collection {
        ...
        $items->add_database_table(self::ACCESSIBILITY_LOG_TABLE, [
            'userid' => 'privacy:metadata:theme_eadtraining_accesslog:userid',
            'courseid' => 'privacy:metadata:theme_eadtraining_accesslog:courseid',
            'cmid' => 'privacy:metadata:theme_eadtraining_accesslog:cmid',
            'action' => 'privacy:metadata:theme_eadtraining_accesslog:action',
            'item' => 'privacy:metadata:theme_eadtraining_accesslog:item',
            'status' => 'privacy:metadata:theme_eadtraining_accesslog:status',
            'activeitems' => 'privacy:metadata:theme_eadtraining_accesslog:activeitems',
            'statejson' => 'privacy:metadata:theme_eadtraining_accesslog:statejson',
            'pageurl' => 'privacy:metadata:theme_eadtraining_accesslog:pageurl',
            'timecreated' => 'privacy:metadata:theme_eadtraining_accesslog:timecreated',
        ], 'privacy:metadata:theme_eadtraining_accesslog');
    ...
    public static function export_user_data(approved_contextlist $contextlist) {
        ...
        writer::with_context(context_system::instance())->export_data(
            [get_string('privacy:accessibilitylogpath', 'theme_eadtraining')],
    ...
    public static function export_user_preferences(int $userid) {
        ...
        if (isset($draweropenindexpref)) {
            $preferencestring = get_string('privacy:drawerindexclosed', 'theme_eadtraining');
        ...
        if (isset($draweropenblockpref)) {
            $preferencestring = get_string('privacy:drawerblockclosed', 'theme_eadtraining');
