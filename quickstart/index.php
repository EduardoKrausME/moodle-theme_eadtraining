...
if (file_exists("{$CFG->libdir}/editor/tiny/lib.php")) {
    $footermustache = [
        ...
        "htmlselect" => $OUTPUT->render_from_template("theme_eadtraining/settings/colors", [
            ...
            [
                "num" => 1, "active" => true, "footer_title" => get_config("theme_eadtraining", "footer_title_1"),
                "footer_html" => get_config("theme_eadtraining", "footer_html_1"),
            ], [
                "num" => 2, "footer_title" => get_config("theme_eadtraining", "footer_title_2"),
                "footer_html" => get_config("theme_eadtraining", "footer_html_2"),
            ], [
                "num" => 3, "footer_title" => get_config("theme_eadtraining", "footer_title_3"),
                "footer_html" => get_config("theme_eadtraining", "footer_html_3"),
            ], [
                "num" => 4, "footer_title" => get_config("theme_eadtraining", "footer_title_4"),
