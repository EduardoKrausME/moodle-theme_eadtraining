...
function theme_eadtraining_coursemodule_edit_post_actions($data, $course) {
    ...
    $hascustomimage =
        isset($data->theme_eadtraining_customimage) &&
        theme_eadtraining_draft_has_files($data->theme_eadtraining_customimage);
    $hascustomicon =
        isset($data->theme_eadtraining_customicon) &&
        theme_eadtraining_draft_has_files($data->theme_eadtraining_customicon);
        ...
        if (!empty($areafiles)) {
            ...
            if (in_array($mimetype, $supported, true)) {
                try {
                    ...
                    $filearea = "theme_eadtraining_customicon";
