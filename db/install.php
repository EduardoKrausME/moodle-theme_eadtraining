...
function xmldb_theme_eadtraining_install() {
    ...
    theme_eadtraining_set_config("breadcrumb_show_mycourses_courses", 0);
    theme_eadtraining_set_config("breadcrumb_show_categories", 0);
    theme_eadtraining_set_config("breadcrumb_show_course", 0);
    theme_eadtraining_set_config("breadcrumb_show_navigation_duplicates", 0);
    theme_eadtraining_set_config("breadcrumb_show_sections", 0);
    theme_eadtraining_set_config("breadcrumb_show_no_link_items", 0);

    theme_eadtraining_set_config("footer_background_color", "#314755");
