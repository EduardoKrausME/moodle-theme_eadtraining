...
$string['logintheme'] = 'Tema da tela de login';
...
$string['logintheme_desc'] = 'Selecione o tema visual que será exibido na tela de login.';
$string['logintheme_selva-canopy'] = 'Selva Canopy';
