...
$coursesmustache = [
    ...
    "courseid" => $courseid,
    "override_course_primarycolor" => get_config("theme_eadtraining", "override_course_primarycolor_{$courseid}"),
    "override_course_secondarycolor" => get_config("theme_eadtraining", "override_course_secondarycolor_{$courseid}"),
    "colorselect" => $OUTPUT->render_from_template("theme_eadtraining/settings/colors", [
        "coursecolor" => true,
        "colors" => $themecolors,
        "defaultcolor" => theme_eadtraining_default("override_course_primarycolor_{$courseid}", $brandcolor),
        ...
        "secondary_color" => theme_eadtraining_secondary_color($courseid),
    ]),
];
