...
$string['accessibilityreport_category_description'] = 'Reports provided by theme EAD Training.';
...
$string['accessibilityreport_description'] = 'Report with VLibras clicks, accessibility toolbar openings, and resource activation/deactivation.';
...
$string['pageeditor_activity_settings'] = 'Activity settings';
$string['pageeditor_builder_description'] = 'Add, reorder and edit visual blocks for this Moodle page. When a block is saved, the Moodle page content is updated automatically.';
$string['pageeditor_builder_title'] = 'Theme page editor';
$string['pageeditor_linked'] = 'This Moodle page is managed by the theme visual editor. The default Moodle content editor is hidden to avoid editing the same content in Tiny or Atto.';
$string['pageeditor_open'] = 'Open visual editor';
$string['pageeditor_open_floating'] = 'Edit with visual editor';
$string['pageeditor_save_to_open'] = 'Save this activity to open the theme editor.';
$string['pageeditor_selected'] = 'Theme editor selected.';
$string['pageeditor_suggestion'] = 'Create this Moodle page with the theme visual editor instead of editing the content in Tiny or Atto.';
$string['pageeditor_title'] = 'Theme visual editor';
$string['pageeditor_use'] = 'Use theme editor';
$string['pageeditor_view_page'] = 'View Moodle page';
...
$string['privacy:metadata'] = 'The Ead Training theme stores accessibility usage logs and user preferences.';
...
$string['privacy:metadata:theme_eadtraining_accesslog'] = 'Stores clicks and state changes in the theme accessibility tools.';
$string['privacy:metadata:theme_eadtraining_accesslog:action'] = 'The type of accessibility interaction.';
$string['privacy:metadata:theme_eadtraining_accesslog:activeitems'] = 'The active accessibility items after the interaction.';
$string['privacy:metadata:theme_eadtraining_accesslog:cmid'] = 'The course module detected when the interaction happened.';
$string['privacy:metadata:theme_eadtraining_accesslog:courseid'] = 'The course detected when the interaction happened.';
$string['privacy:metadata:theme_eadtraining_accesslog:item'] = 'The accessibility item that was clicked or changed.';
$string['privacy:metadata:theme_eadtraining_accesslog:pageurl'] = 'The page where the interaction happened.';
$string['privacy:metadata:theme_eadtraining_accesslog:statejson'] = 'The browser accessibility state after the interaction.';
$string['privacy:metadata:theme_eadtraining_accesslog:status'] = 'The resulting status after the interaction.';
$string['privacy:metadata:theme_eadtraining_accesslog:timecreated'] = 'The time when the interaction happened.';
$string['privacy:metadata:theme_eadtraining_accesslog:userid'] = 'The user who interacted with the accessibility tool.';
