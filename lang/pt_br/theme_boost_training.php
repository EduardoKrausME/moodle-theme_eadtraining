...
$string['background_course_image'] = 'Imagem de fundo do curso';
$string['background_course_image_desc'] = 'Define uma imagem de fundo para o cabeçalho de todos os cursos. Esta imagem será exibida no topo da página do curso e pode ser substituída individualmente nas configurações do curso.';
...
$string['customfield_field_name_desc'] = '<p>Este campo permite escolher se uma imagem será exibida no topo da página do curso. Quando ativado, uma imagem de sua escolha será exibida em destaque, aumentando o apelo visual do curso e proporcionando uma experiência mais personalizada para os usuários.</p>';
...
$string['rawscss_desc'] = 'Use este campo para fornecer código SCSS ou CSS que será injetado ao final da folha de estilos.';
$string['rawscsspre'] = 'SCSS inicial puro';
$string['rawscsspre_desc'] = 'Neste campo você pode fornecer código SCSS de inicialização, que será injetado antes de tudo. Na maioria das vezes, esta configuração será usada para definir variáveis.';
...
$string['privacy:metadata:preference:draweropenblock'] = 'Preferência do usuário para ocultar ou exibir o painel lateral com blocos.';
$string['privacy:metadata:preference:draweropenindex'] = 'Preferência do usuário para ocultar ou exibir o painel lateral com o índice do curso.';
$string['privacy:metadata:preference:draweropennav'] = 'Preferência do usuário para ocultar ou exibir o menu de navegação lateral.';
$string['privacy:drawerindexclosed'] = 'A preferência atual para o índice lateral está como fechado.';
$string['privacy:drawerindexopen'] = 'A preferência atual para o índice lateral está como aberto.';
$string['privacy:drawerblockclosed'] = 'A preferência atual para o painel de blocos está como fechado.';
$string['privacy:drawerblockopen'] = 'A preferência atual para o painel de blocos está como aberto.';
...
$string['settings_icons_color_icon'] = 'Definir uma cor personalizada para o ícone.';
