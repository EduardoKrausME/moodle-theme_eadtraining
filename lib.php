...
function theme_eadtraining_get_pre_scss($theme) {
    ...
    $footerbg = theme_eadtraining_default("footer_background_color", $brandcolor);
    ...
    if ($CFG->theme == "degrade") {
        $angle = theme_eadtraining_default("angle", 30);
        $gradient1 = theme_eadtraining_default("brandcolor_gradient_1", "#f54266");
        $gradient2 = theme_eadtraining_default("brandcolor_gradient_2", "#3858f9");
        $scss .= "
