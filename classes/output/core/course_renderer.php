...
class course_renderer extends \core_course_renderer {
    ...
    private function get_class_row() {
        return "card-grid mx-0 row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 ";
    }
    ...
    protected function coursecat_coursebox(coursecat_helper $chelper, $course, $additionalclasses = "") {
        ...
        return $this->output->render_from_template("theme_eadtraining/core_course/cardhome", $cardhomemustache);
    }
